          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  Discover the untouched beauty of Pakistan with Pakistani
                  Mountain Tours. From the majestic peaks of the Karakoram to
                  the serene valleys of the north, we craft unforgettable
                  journeys filled with culture, adventure, and natural wonder.
                </p>
