      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-4 text-gray-700 text-sm md:text-base">
            <li>
              <strong>Day 1 – Islamabad:</strong> Arrival and briefing, evening flight. Overnight at Hotel Crossroads.
            </li>
            <li>
              <strong>Day 2 – Islamabad to Skardu:</strong> Scenic flight, view of Nanga Parbat, visit Manthal Buddha, Sadpara Lake, and Kachura lakes. Overnight at Himmel Skardu.
            </li>
            <li>
              <strong>Day 3 – Skardu to Hunza:</strong> View 3 mountain ranges, Old Silk Road, Rakaposhi viewpoint, Baltit Fort, Duiker sunset. Overnight at Fairy Land Hotel Hunza.
            </li>
            <li>
