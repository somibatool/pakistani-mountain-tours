...
const PlaceDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-white pt-24 px-4 md:px-10 pb-10 overflow-y-auto mt-10">
      ...
      <p>
      <h1 className='text-3xl font-bold'>  Gilgit Baltistan Pakistan – Land of Lakes and Landscapes Vistas</h1>
      <br />
...
Tour of Naltar valley and Green lake
  ...
  <img src="/src/assets/hunzaganish.jpg" alt="Hunza Tour" className="w-full rounded-lg" />
  <img src="/src/assets/nightview hunza.jpg" alt="Hunza Tour" className="w-full rounded-lg" />
  <img src="/src/assets/skarduheart.jpg" alt="Hunza Tour" className="w-full rounded-lg" />

  <img src="/IMG_1327.jpg" alt="Hunza Tour" className="w-full rounded-lg" />
</div>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-black mb-3">TOUR SCHEDULE</h2>
        <h3 className="text-lg font-bold text-black mb-1">Destination: Gilgit-Baltistan</h3>
